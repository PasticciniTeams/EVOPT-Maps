...
class AStarW4(SearchAlgorithm):
    ...
    def solve(self, problem):
        ...
        frontier.put(AstarNode(problem.init, h=self.heuristic(problem.init, problem.goal) * self.w))
        ...
        while frontier:
            ...
            for a, s in problem.getSuccessors(n.state):
                if s not in reached:
                    ...
                    reached.add(s)
                    new_g = n.g + 1
                    new_h = self.heuristic(s, problem.goal) * self.w
